...
calculate_coefficients <- function(user_arguments) {
  ...
  args$nanoplankter_volume <- (4/3) * 3.14159 * (args$nanoplankter_radius^3)
  ...
  args$zwt <- 9.86 * exp(2.1 * log(args$length_herbivore))
  ...
  args$fmax_alga <- exp(args$fco2_alga*log(10))*0.178 / args$zwt
